...
export default class Admin extends React.Component {
    ...
    createUser = (email, role) => {
            let self = this
                if(self.state.name != "" && this.state.surName != "") {
                    ...
                    fb.auth().createUserWithEmailAndPassword(email, "Qqwerty1!")
    ...
    filters = () => {
        let filterData = [
            [{key: "",value: "Выберите тип"},{key: "teachers",value: "Учителя"},{key: "students",value: "Ученики"}]
        ]
                ...
                <div className="admin">
                    ...
                    <div className="admin-nav">
                        ...
                        <div className="admin-search">
                            <input value={this.state.find} onChange={(f)=>this.setState({find: f.target.value})} type="text" class="searchTerm" placeholder="Поиск"/>
                    ...
                    <div className="add_video" onClick={()=>this.setState({addVideo: true})}>Добавить</div>
                    ...
                    {!this.state.loading ?
                            <div className={this.state.add ? "add-student" : "none"}>
                                <div>
                                    <label>Добавить {this.state.role == "student" ? "ученика":"учителя"}</label>
                        ...
                        <div className="add-student-loading">
                            <div className="spinner"><h1>QC</h1></div>
                        </div>
                    }
                </div>
            )
